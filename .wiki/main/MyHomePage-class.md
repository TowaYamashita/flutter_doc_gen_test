...
[MyHomePage](../main/MyHomePage/MyHomePage.md) ({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key, required [String](https://api.flutter.dev/flutter/dart-core/String-class.html) title})
...
##### [createState](../main/MyHomePage/createState.md)() [State](https://api.flutter.dev/flutter/widgets/State-class.html)&lt;[MyHomePage](../main/MyHomePage-class.md)>



Creates the mutable state for this widget at a given location in the tree. [...](../main/MyHomePage/createState.md)  
_override_
