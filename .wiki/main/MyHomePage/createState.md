...
[State](https://api.flutter.dev/flutter/widgets/State-class.html)&lt;[MyHomePage](../../main/MyHomePage-class.md)> createState
()
...
later inserted into the tree again, the framework will call <a href="../../main/MyHomePage/createState.md">createState</a>
